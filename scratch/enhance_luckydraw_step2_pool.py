...
# The user wants to see the "table" for the people who will be shuffled.
...
content = content.replace(
    re.search(r'<!-- DIRECT MODE: Fixed Front Positions -->.*?</div>\s+</div>\s+</div>', content, re.DOTALL).group(0),
    new_direct_mode_step2 + "\n                </div>\n            </div>"
)
