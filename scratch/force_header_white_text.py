...
# Force white text on blue/indigo backgrounds in the header
new_header_buttons = """                            <div class="flex items-start space-x-1.5 pt-1">
                                ...
                                <button v-if="lotteryMode === false && !selectionFiltered" 
                                    ...
                                    :class="selectionMode === 'fixed' ? 'bg-indigo-600 border-indigo-600' : 'bg-indigo-50 border-indigo-100 text-indigo-600'"
...
print("LuckyDraw: Header buttons forced to white text on blue/indigo backgrounds.")
