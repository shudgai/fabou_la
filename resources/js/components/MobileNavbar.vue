<template>
    ...
    ]" class="bottom-0 left-0 right-0 bg-white border-t border-white z-[3000]"         style="height: calc(7dvh + env(safe-area-inset-bottom)); padding-bottom: env(safe-area-inset-bottom);">
