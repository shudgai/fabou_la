<template>
    ...
    ]" class="bottom-0 left-0 right-0 bg-white border-t border-slate-200 z-[3000] shadow-[0_-4px_20px_rgba(0,0,0,0.05)]" style="height: calc(7vh + env(safe-area-inset-bottom)); padding-bottom: env(safe-area-inset-bottom);">
