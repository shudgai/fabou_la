    ...
    <div class="h-full bg-white flex flex-col overflow-clip">
        ...
        <div class="border-b border-slate-100 bg-white sticky top-0 z-20 flex items-center shrink-0 w-full" style="padding: 12px 12px; min-height: 52px;">
            ...
            <div class="flex items-center gap-2">
                        ...
                        <h3 class="leading-tight font-outfit tracking-widest break-words !font-black !text-[#0f172a]" style="color: #0f172a !important; font-size: 30px !important; padding-top: 5px; font-weight: 900 !important;">其他記錄專區</h3>
                    </div>
        </div>
