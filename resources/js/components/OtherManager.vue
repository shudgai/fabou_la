    ...
    <div class="h-full bg-white flex flex-col other-manager-module relative overflow-clip">
        ...
        <div v-if="!activeFolderId && !showLuckyDraw" class="h-full bg-white flex flex-col relative overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar w-full">
                <div class="grid grid-cols-1 gap-1 px-6 pt-1 pb-24 place-items-center">
        ...
        <div v-else class="flex-grow flex flex-col bg-slate-100 md:bg-white overflow-hidden w-full relative md:h-[90dvh]">
            ...
            <div class="border-b border-slate-300 bg-white sticky top-0 z-[110] w-full" style="padding: 0 2px 4px; min-height: 52px;">
